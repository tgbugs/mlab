...
class Subject(HasMetaData, HasDataFiles, HasSwcHwRecords, HasExperiments, HasProperties, HasHardware, HasNotes, HasTreeStructure, Base):
    ...
    #FIXME who participated and when did it happen, the EXACT relationship between input and output can probably be determined elsewhere, or better yet in an association table?
    ...
    @validates('reproduction_experiment_id','startDateTime','sDT_abs_error','endDateTime') #FIXME FIXME
